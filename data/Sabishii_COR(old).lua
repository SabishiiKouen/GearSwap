...
function init_gear_sets()
    ...
    sets.precast.WS['Last Stand'] = set_combine(sets.precast.WS, {back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Weapon skill damage +10%',}},ring2="Regal Ring", ear2="Telos Earring"})
    ...
    sets.engaged.DW.STP.MaxHaste = sets.engaged.DW.LowHaste
    ...
    sets.DeathPenalty_R = {main={name="Rostam", bag="wardrobe1"}, sub="Tauret", ranged="Death Penalty"}
    ...
    sets.Armageddon_M.Acc = {main={name="Rostam", bag="wardrobe1"}, sub={name="Rostam", bag="wardrobe4"}, ranged="Armageddon"}
