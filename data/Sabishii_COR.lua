...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll.Duration = {head="Lanun Tricorne +3",main="Rostam", range="Compensator", hands="Chasseur's Gants +1",neck="Regal Necklace", back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Damage taken-5%',}},}
    ...
    sets.precast.FC = {
        ...
        body={ name="Taeon Tabard", augments={'Accuracy+20 Attack+20','Potency of "Cure" effect received+7%','Phalanx +3',}}, --9
    ...
    sets.precast.RA = {
        ...
        feet="Oshosi Leggings +1", --10/0
        neck="Comm. Charm +2", --4/0
        back={name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+10','"Store TP"+10',}},--10/0
    ...
    sets.precast.WS['Last Stand'] = set_combine(sets.precast.WS, {back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Weapon skill damage +10%',}},ear2="Ishvara Earring"})
    ...
    sets.precast.WS['Hot Shot'] = sets.precast.WS
    ...
    sets.precast.WS['Evisceration'].Acc = set_combine(sets.precast.WS['Evisceration'], {
        ...
        legs={name="Herculean Trousers", augments={'Accuracy+25 Attack+25','Weapon skill damage +3%','DEX+13','Accuracy+6','Attack+4',}},
        })
	...
	sets.precast.WS['Extenerator'] = sets.precast.WS['Swift Blade']
    ...
    sets.DeathPenalty_M = {main={name="Rostam", bag="wardrobe1"}, sub="Tauret", ranged="Death Penalty"}
    sets.DeathPenalty_M.Acc = {main={name="Rostam", bag="wardrobe1"}, sub={name="Rostam", bag="wardrobe"}, ranged="Death Penalty"}
    sets.DeathPenalty_R = {main={name="Rostam", bag="wardrobe1"}, sub="Gleti's Knife", ranged="Death Penalty"}
    sets.DeathPenalty_R.Acc = {main={name="Rostam", bag="wardrobe1"},sub="Kustawi +1", ranged="Death Penalty"}
    sets.Armageddon_M = {main="Tauret", sub="Gleti's Knife", ranged="Anarchy +2"}
    sets.Armageddon_M.Acc = {main="Tauret", sub="Gleti's Knife", ranged="Anarchy +2"}
    sets.Armageddon_R = {main="Naegling", sub="Tauret", ranged="Fomalhaut"}
    sets.Armageddon_R.Acc = sets.Armageddon_R
    sets.Fomalhaut_M = {main={name="Rostam", bag="wardrobe1"}, sub="Tauret", ranged="Fomalhaut"}
    sets.Fomalhaut_M.Acc = {main={name="Rostam", bag="wardrobe1"}, sub="Tauret", ranged="Fomalhaut"}
    sets.Fomalhaut_R = {main={name="Rostam", bag="wardrobe1"},  sub="Kustawi +1", ranged="Fomalhaut"}
