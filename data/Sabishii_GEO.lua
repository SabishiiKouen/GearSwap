...
function get_sets()
    ...
    sets.me.idle.normal = {main = "Idris", sub="Ammurapi Shield",
    ...
    sets.pan.idle.normal = {main="Idris",
    sub="Ammurapi Shield",
    range={ name="Dunna", augments={'MP+20','Mag. Acc.+10','"Fast Cast"+3',}},
    ...
    sets.pan.idle.dt = set_combine(sets.pan.idle.normal,{neck="Loricate Torque +1",back="Solemnity Cape",feet="Nyame Sollerets",
    ...
    sets.me.melee = set_combine(sets.me.idle[idleMode],{main="Idris", sub="Ammurapi Shield",
		head="Nyame Helm",
		body="Nyame Mail",
		hands="Nyame Gauntlets",
		legs="Nyame Flanchard",
    ...
    -- Luopan is out
	sets.pan.melee = set_combine(sets.pan.idle[idleMode],{main="Idris",
    sub="Ammurapi Shield",
    range={ name="Dunna", augments={'MP+20','Mag. Acc.+10','"Fast Cast"+3',}},
    head={ name="Telchine Cap", augments={'Mag. Evasion+17','Pet: "Regen"+3','"Regen" potency+2',}},
    body="Nyame Mail",
	...
	sets.me["Black Halo"] = {head="Nyame Helm",
		body="Nyame Mail",
		hands="Nyame Gauntlets",
		legs="Nyame Flanchard",
		feet="Nyame Sollerets",
    ...
    sets.precast.casting = {main="Idris",
    sub="Ammurapi Shield",
    range={ name="Dunna", augments={'MP+20','Mag. Acc.+10','"Fast Cast"+3',}},
	...
	-- For Geo spells /
    sets.midcast.geo = set_combine(sets.midcast.casting,{main="Idris", head="Azimuth Hood +1",
		neck="Bagua Charm +2",
	...
	-- For Indi Spells
    sets.midcast.indi = set_combine(sets.midcast.geo,{back="Lifestream Cape",
		legs="Bagua Pants +3",
	...
	sets.midcast.MB.normal = set_combine(sets.midcast.nuking.normal, {hands="Bagua Mitaines +3",
		head="Agwu's Cap",
		body="Ea Houppelande",
		legs="Ea Slops",
	...
	-- Enfeebling
	sets.midcast.IntEnfeebling = set_combine(sets.midcast.casting,{main="Daybreak",
		head="Geomancy Galero +2",
		neck="Bagua Charm +2",
		body="Geomancy tunic +2",
		hands="Geomancy Mitaines +2",
		ring1="Kishar Ring",
		ring2="Stikini Ring",
		legs="Geoamncy pants +2",
		waist="Luminary Sash",
		back={ name="Nantosuelta's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','Pet: "Regen"+10','Pet: "Regen"+5',}},
		feet="Geomancy Sandals +3",

    })
	sets.midcast.MndEnfeebling = set_combine(sets.midcast.casting, sets.midcast.IntEnfeebling)
	
    -- Enhancing
    sets.midcast.enhancing = set_combine(sets.midcast.casting,{head={ name="Telchine Cap", augments={'Mag. Evasion+24','Potency of "Cure" effect received+5%','Enh. Mag. eff. dur. +5',}},
	...
	sets.midcast["Drain"] = set_combine(sets.midcast.IntEnfeebling, {main="Rubicundity",
